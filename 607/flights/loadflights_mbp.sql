...
LOAD DATA INFILE '/Users/ajbentley/Dropbox/cuny_msds/bridge/sql/flights/airlines.csv'
INTO TABLE airlines
...
LOAD DATA INFILE '//Users/ajbentley/Dropbox/cuny_msds/bridge/sql/flights/airports.csv'
INTO TABLE airports
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/Users/ajbentley/Dropbox/cuny_msds/bridge/sql/flights/flights.csv'
INTO TABLE flights
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/Users/ajbentley/Dropbox/cuny_msds/bridge/sql/flights/planes.csv'
INTO TABLE planes
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/Users/ajbentley/Dropbox/cuny_msds/bridge/sql/flights/weather.csv' 
INTO TABLE weather
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
